...
const API_DATA = [
    ...
    {
        id: "consultar-dni",
        category: "Consultas de Identidad y Empresa",
        method: "GET",
        path: "/v1/dni/{dni}",
        title: "Consulta DNI",
        description: "Consulta los datos de identidad asociados a un Documento Nacional de Identidad (DNI) a través de los registros integrados.",
        authorizations: [
        ...
        pathParams: [
            { name: "dni", type: "string", required: true, description: "Número de DNI de 8 dígitos a consultar.", example: "45678912" }
        ],
        queryParams: [],
        bodyParams: null,
        responses: {
            "200": {
                status: "200 OK",
                description: "Datos del ciudadano retornados correctamente.",
                data: {
                    status: 200,
                    success: true,
                    message: "Exito",
                    data: {
                        ...
                        nombre_completo: "RODRIGUEZ QUISPE, CARLOS ALBERTO",
                        departamento: "LIMA",
                        provincia: "LIMA",
                        distrito: "MIRAFLORES",
                        direccion: "AV. LARCO 456",
                        direccion_completa: "AV. LARCO 456, LIMA - LIMA - MIRAFLORES",
                        ubigeo_reniec: "150122",
                        ubigeo_sunat: "150122",
                        ubigeo: ["15", "01", "22"],
            ...
            "400": {
                ...
                data: {
                    status: 400,
                    success: false,
                    message: "El DNI ingresado debe contener exactamente 8 dígitos numéricos.",
                    error_code: "DNI_FORMAT_INVALID"
                }
            },
            "404": {
                status: "404 Not Found",
                description: "DNI no encontrado en los registros.",
                data: {
                    status: 404,
                    success: false,
                    message: "No se encontraron registros para el DNI consultado.",
    ...
    },
    {
        ...
        path: "/v1/ruc/{ruc}",
        title: "Consulta RUC",
        description: "Consulta los datos tributarios de un Registro Único de Contribuyentes (RUC) asociados a empresas transportistas o clientes.",
        authorizations: [
            { name: "Authorization", type: "string", location: "header", required: true, description: "Token Bearer de autenticación." }
        ],
        pathParams: [
            { name: "ruc", type: "string", required: true, description: "Número de RUC de 11 dígitos a consultar.", example: "20601234567" }
        ],
        queryParams: [],
        bodyParams: null,
        responses: {
            "200": {
                status: "200 OK",
                description: "Datos del contribuyente obtenidos con éxito.",
                data: {
                    status: 200,
                    success: true,
                    message: "Exito",
                    data: {
                        ...
                        nombre_comercial: "TRANS-ANDINOS",
                        estado: "ACTIVO",
                        condicion: "HABIDO",
                        direccion: "AV. MATERIALES NRO. 2450 URB. INDUSTRIAL",
                        departamento: "LIMA",
                        provincia: "LIMA",
                        distrito: "CERCADO DE LIMA",
                        ubigeo: "150101",
                        actividad_economica: "4923 - TRANSPORTE DE CARGA POR CARRETERA",
                        sistema_emision: "SOL / MANUAL",
                        afiliado_ple: false
                    }
                }
            },
            "404": {
                ...
                data: {
                    status: 404,
                    success: false,
                    message: "El RUC consultado no existe en los registros oficiales.",
                    error_code: "RUC_NOT_FOUND"
                }
            }
        }
    },
    {
        ...
        method: "GET",
        path: "/v1/vehiculos/placa/{placa}",
        title: "Placa de vehículo",
        description: "Consulta la ficha técnica del vehículo registrado en el MTC (Ministerio de Transportes) y SUNARP a través de la placa.",
        authorizations: [
            { name: "Authorization", type: "string", location: "header", required: true, description: "Token Bearer de autenticación." }
        ],
        pathParams: [
            { name: "placa", type: "string", required: true, description: "Número de placa de rodaje del vehículo (con o sin guion).", example: "F3B-823" }
        ],
        queryParams: [],
        bodyParams: null,
        responses: {
            "200": {
                status: "200 OK",
                description: "Ficha del vehículo obtenida correctamente.",
                data: {
                    status: 200,
                    success: true,
                    message: "Exito",
                    data: {
                        placa: "F3B823",
                        partida_registral: "11048392",
                        categoria: "N3 (Remolcador / Tracto)",
                        marca: "VOLVO",
                        modelo: "FH12 420 6x4",
                        color: "BLANCO ROJO",
                        chasis: "YV2A4DCD94A582310",
                        motor: "D12D938472B",
                        ...
                        numero_ejes: 3,
                        numero_ruedas: 10,
                        estado_mtc: "HABILITADO",
                        autorizacion_carga: "VIGENTE (Exp. 4832-2025)"
                    }
                }
            },
            "400": {
                status: "400 Bad Request",
                description: "Placa mal formateada.",
                data: {
                    status: 400,
                    success: false,
                    message: "La placa provista no cumple con el formato estándar (ej. F3B-823 o F3B823).",
                    error_code: "PLATE_FORMAT_INVALID"
                }
            }
        }
    },
    {
        ...
        category: "Vehículos y Tránsito",
        method: "GET",
        path: "/v1/vehiculos/placa/{placa}/soat",
        title: "SOAT de vehículo",
        description: "Verifica el estado de vigencia y detalles del Seguro Obligatorio de Accidentes de Tránsito (SOAT) para el vehículo consultado.",
        authorizations: [
            { name: "Authorization", type: "string", location: "header", required: true, description: "Token Bearer de autenticación." }
        ],
        pathParams: [
            { name: "placa", type: "string", required: true, description: "Placa de rodaje a consultar SOAT.", example: "F3B-823" }
        ],
        queryParams: [],
        bodyParams: null,
        responses: {
            "200": {
                status: "200 OK",
                description: "Estado del SOAT obtenido.",
                data: {
                    status: 200,
                    success: true,
                    message: "Consulta de SOAT exitosa",
                    data: {
                        placa: "F3B823",
                        estado: "VIGENTE",
                        aseguradora: "POSITIVA SEGUROS",
                        numero_poliza: "SOAT-2026-8947239",
                        fecha_inicio: "2025-10-15T00:00:00Z",
                        fecha_fin: "2026-10-15T23:59:59Z",
                        tipo_soat: "ELECTRÓNICO",
                        uso_vehiculo: "TRANSPORTE DE CARGA / MERCANCÍAS"
                    }
                }
            },
            "404": {
